...
struct e1000_mac_operations {
	...
	s32  (*get_link_up_info)(struct e1000_hw *, u16 far *, u16 far *);
	s32  (*led_on)(struct e1000_hw *);
	s32  (*led_off)(struct e1000_hw *);
	void (*update_mc_addr_list)(struct e1000_hw *, u8 far *, u32);
...
struct e1000_phy_operations {
	...
	s32  (*read_reg)(struct e1000_hw *, u32, u16 far*);
	s32  (*read_reg_locked)(struct e1000_hw *, u32, u16 far *);
	s32  (*read_reg_page)(struct e1000_hw *, u32, u16 far *);
...
struct e1000_nvm_operations {
	s32  (*acquire)(struct e1000_hw *);
	s32  (*read)(struct e1000_hw *, u16, u16, u16 far*);
	void (*release)(struct e1000_hw *);
	s32  (*update)(struct e1000_hw *);
	s32  (*valid_led_default)(struct e1000_hw *, u16 far *);
	s32  (*validate)(struct e1000_hw *);
	s32  (*write)(struct e1000_hw *, u16, u16, u16 far*);
};
