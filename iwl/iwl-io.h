...
///!!!///	trace_iwlwifi_dev_iowrite8(priv, ofs, val);
	iowrite8(val, (u8 far *)priv->hw_base + ofs);
}
...
///!!!///	trace_iwlwifi_dev_iowrite32(priv, ofs, val);
	iowrite32(val, (u8 far *)priv->hw_base + ofs);
}
...
{
	u32 val = ioread32((u8 far *)priv->hw_base + ofs);
...
///!!!///SPINLOCK///	spin_lock_irqsave(&p->reg_lock, reg_flags);
	__iwl_set_bit(__FILE__, __LINE__, p, r, m);
///!!!///SPINLOCK///	spin_unlock_irqrestore(&p->reg_lock, reg_flags);
}
#else
static inline void iwl_set_bit(struct iwl_priv *p, u32 r, u32 m)
{
...
///!!!///SPINLOCK///	spin_lock_irqsave(&priv->reg_lock, reg_flags);
	iwl_grab_nic_access(priv);
	value = __iwl_read_direct32(__FILE__, __LINE__, priv, reg);
	iwl_release_nic_access(priv);
///!!!///SPINLOCK///	spin_unlock_irqrestore(&priv->reg_lock, reg_flags);
	return value;
}
