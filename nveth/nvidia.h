...
#define RX_RING_DEFAULT		256
#define TX_RING_DEFAULT		128
...
#define NV_TX2_TSO_MAX_SIZE	((u32)1<<NV_TX2_TSO_MAX_SHIFT)
...
#define NV_R32(reg) ReadDword(Priv.ba+reg)
#define NV_W32(val,reg) WriteDword(Priv.ba+reg, val)
#define NV_R16(reg) ReadWord(Priv.ba+reg)
#define NV_W16(val,reg) WriteWord(Priv.ba+reg, val)
#define NV_R8(reg) ReadByte(Priv.ba+reg)
#define NV_W8(val,reg) WriteByte(Priv.ba+reg, val)
